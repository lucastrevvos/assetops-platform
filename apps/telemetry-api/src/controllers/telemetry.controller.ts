...
export async function createTelemetry(req: Request, res: Response, next: NextFunction){
...
export async function listTelemetry(_req: Request, res: Response, next: NextFunction){
